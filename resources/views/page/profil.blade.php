	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="profile-cover">
				<div class="profile-cover-img" style="background-image: url(/uploads/cover/{{ Auth::user()->cover }})"></div>
				<div class="media">
					<div class="media-left">
						<a href="#" class="profile-thumb">
							<img src="/uploads/avatars/{{ Auth::user()->avatar }}" class="img-circle" alt="">
						</a>
					</div>

					<div class="media-body">
							<h1>{{ Auth::user()->nama }}<small class="display-block">{{ Auth::user()->email }}</small></h1>
					</div>

					<div class="media-right media-middle">
						<ul class="list-inline list-inline-condensed no-margin-bottom text-nowrap">
							<li><a href="{{ route('gantifoto') }}" class="btn btn-default"><i class="icon-file-picture position-left"></i>Ganti Foto</a></li>
						</ul>
					</div>
				</div>
			</div>
